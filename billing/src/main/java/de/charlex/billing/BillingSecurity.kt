...
object BillingSecurity {
    ...
    fun verifyPurchase(
        ...
        if (TextUtils.isEmpty(signedData) || TextUtils.isEmpty(base64PublicKey) ||
            ...
            Log.d("BillingSecurity", "Purchase verification failed: missing data.")
            return false
        }
    ...
    private fun verify(publicKey: PublicKey?, signedData: String, signature: String?): Boolean {
        ...
        try {
            ...
            Log.w("BillingSecurity", "Invalid key specification.")
        } catch (e: SignatureException) {
            Log.w("BillingSecurity", "Signature exception.")
        }
        return false
    }
}
